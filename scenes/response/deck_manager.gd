...
## Ported unchanged from D:\GitHub\the-spire\Scripts\DeckManager.gd. Generic
## draw/hand/discard pile management with zero theming -- nothing here needed to
## change to serve a cybersecurity Response deck instead of the-spire's.
